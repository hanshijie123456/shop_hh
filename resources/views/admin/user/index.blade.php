    ...
    <div class="mws-panel-body no-padding">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="@if($k % 2 == 0)odd @else even @endif">
                        ...
                        <td class=" ">
                            ...
                            <img src="{{$v->profile}}" alt="" width='80'>
                        </td>
                        <td class=" ">
                            {{--$v->status ? '启用' : '禁用'--}}
                         ...
                         <td class=" ">
                            ...
                            <a class='btn btn-info' href="/admin/user_role/{{$v->id}}" title='添加角色'><i class='icon-github'></i></a>

                            <a class='btn btn-primary' href="/admin/user/{{$v->id}}/edit">修改</a>
            ...
            <div class="dataTables_info" id="DataTables_Table_1_info">
                <a class='btn btn-primary' href="/admin/user/create" title="返回"><i class='icon-bended-arrow-left'></i></a>
            </div>
